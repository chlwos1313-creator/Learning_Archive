/**
 * data.js - 지역 및 은행 데이터 모듈
 * NF1003: 데이터를 별도 JS 파일로 분리
 *
 * data.json을 기반으로 전역 변수로 노출
 */
...
const mapInfo = [
  ...
  {
    "name": "인천광역시",
    "countries": ["강화군","계양구","남구","남동구","동구","부평구","서구","연수구","옹진군","중구"]
  },
  {
    "name": "광주광역시",
  ...
  },
  {
    ...
    "countries": [
      ...
      "안성시","안양시 동안구","안양시 만안구","양주시","양평군","여주군",
  ...
  },
  {
    ...
    "countries": [
      ...
      "서천군","아산시","연기군","예산군","천안시 동남구","천안시 서북구",
      "청양군","태안군","홍성군"
    ]
  },
  {
...
// 은행 목록
const bankInfo = [
  "국민은행","신한은행","우리은행","하나은행","산업은행",
  "농협","새마을금고","신협","우체국","기업은행",
  "부산은행","대구은행","광주은행","경남은행","전북은행","제주은행","수협"
];
